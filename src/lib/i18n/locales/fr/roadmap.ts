export const roadmap = {
  ...
  'roadmap.zoomYear': 'Année',
  'roadmap.zoomQuarter': 'Trimestre',
  'roadmap.zoomMonth': 'Mois',
  'roadmap.zoomWeek': 'Semaine',
  'roadmap.zoomDay': 'Jour',
  'roadmap.zoomFit': 'Ajuster',
  ...
  'ov.summary': '{{closed}} sur {{total}} éléments livrés',
  'ov.nextLabel': 'Prochaine livraison',
  'ov.noMilestones': 'Rien de partagé pour l’instant.',
  'ov.nextDelivery': 'Prochaine livraison ~{{date}}',
  'ov.now': 'Maintenant',
  'ov.next': 'Ensuite',
  'ov.milestones': 'Jalons',
  'ov.delivered': 'Livré',
  'ov.editSummary': 'Modifier le résumé client',
