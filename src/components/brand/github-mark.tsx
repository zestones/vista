...
/** GitHub Octocat mark. lucide no longer ships brand icons, so it lives here. Inherits `currentColor`. */
function GitHubMark({ size = 16, ...props }: React.ComponentProps<'svg'> & { size?: number }) {
  return (
